...
r1_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\ROMANCE REVIEWS.xlsx",0)
r2_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\ROMANCE REVIEWS.xlsx",1)
r3_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\ROMANCE REVIEWS.xlsx",2)
r4_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\ROMANCE REVIEWS.xlsx",3)
r5_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\ROMANCE REVIEWS.xlsx",4)
r6_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\ROMANCE REVIEWS.xlsx",5)
r7_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\ROMANCE REVIEWS.xlsx",6)
r8_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\ROMANCE REVIEWS.xlsx",7)
r9_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\ROMANCE REVIEWS.xlsx",8)
r10_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\ROMANCE REVIEWS.xlsx",9)
...
print ('So,The following is our "Sentiment Analysis" for the Top 10 Indian Web Series(Romance Genre) : ')
...
selected_stop_words=['show','season','one','good','season','watch','story','character','watched','episodes','bajpayee','bajpai','manoj','episode','review','actor','actors']
stopwords = list(additional_stop_words) + selected_stop_words + add_stop_words + list(STOPWORDS)
