...
r1_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\HORROR REVIEWS.xlsx",0)
r2_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\HORROR REVIEWS.xlsx",1)
r3_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\HORROR REVIEWS.xlsx",2)
r4_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\HORROR REVIEWS.xlsx",3)
r5_df=pd.read_excel(r"C:\Users\Asus\Desktop\Intern Work-IIM Ranchi\ALL REVIEWS\HORROR REVIEWS.xlsx",4)
...
# #### Findings
# We can clearly see that the word cloud has major chunk of positve reviews(roughly 60%) , some negative reviews (roughly 25%), with some neutral reviews(15%).
# 
...
print ('So,The following is our "Sentiment Analysis" for the Top 10 Indian Web Series(Horror Genre) : ')
...
selected_stop_words=['show','season','one','season','watch','story','web','netflix','movie','episodes','bajpayee','bajpai','manoj','episode','review','actor','actors']
stopwords = list(additional_stop_words) + selected_stop_words + add_stop_words + list(STOPWORDS)
...
selected_stop_words=['show','season','one','good','season','watch','story','bajpayee','movie','bajpai','manoj','episode','review','actor','actors']
stopwords = list(additional_stop_words) + selected_stop_words + add_stop_words + list(STOPWORDS)
...
selected_stop_words=['show','season','one','good','thriller','season','shame','movie','watch','story','masterpiece','bajpayee','bajpai','manoj','episode','review','actor','actors']
stopwords = list(additional_stop_words) + selected_stop_words + add_stop_words + list(STOPWORDS)
